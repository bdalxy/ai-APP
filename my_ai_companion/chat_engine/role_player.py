...
class RolePlayer:
    ...
    def __init__(
        ...
        api_client: 'DeepSeekAPIClient' = None,
        ...
        **kwargs
        ...
        try:
            ...
            if recall_memory and self.memory_storage:
                relevant_memories = self.memory_storage.search_memory(
                    conversation_id, user_message, max_results=3
                )
            ...
            if result.get("choices") and len(result["choices"]) > 0:
                ...
                if self.memory_storage:
                    self.memory_storage.save_message(
                        ...
                        content=reply,
                        metadata={
                            "character": self.character_card.name if self.character_card else "AI"
                        }
                    )
