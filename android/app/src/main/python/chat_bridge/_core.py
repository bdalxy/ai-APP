...
def _build_custom_preset(
    ...
    return TokenPreset(
        ...
        system_prompt_chars=int(context_size * 0.30),
        card_max_chars=int(context_size * 0.20),
        world_book_max_chars=int(context_size * 0.10),
        memories_max_chars=int(context_size * 0.10),
        guideline_max_chars=int(context_size * 0.05),
